...
export default function Header() {
    ...
    return (
        <header className="z-[999] relative">
            <motion.div className="fixed top-0 left-1/2 h-[4.5rem] w-full rounded-none border border-white border-opacity-40 bg-white bg-opacity-80 shadow-lg shadow-black/[0.03] blackdrop-blur-[0.5rem] dark:bg-stone-950/85 dark:border-stone-800 dark:shadow-amber-950/10 sm:top-6 sm:h-[3.25rem] sm:w-[45rem] sm:rounded-full"
